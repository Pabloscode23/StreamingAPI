 ...
 * para crear una instancia del servicio de streaming de tipo {@link WatchModeService}.
 *
 ...
 * un servicio de tipo {@link WatchModeService}.
 */
public class WatchModeFactory implements AbstractStreamingFactory {

    /**
     * Crea e inicializa una nueva instancia del servicio de streaming de tipo {@link WatchModeService}.
     *
     * Este método es parte del patrón **Factory Method** implementado en la interfaz {@link AbstractStreamingFactory}.
     *
     * @return Una nueva instancia de {@link WatchModeService}, que es una implementación de {@link StreamingService}.
     */
    @Override
